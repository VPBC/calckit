...
const related = [
  ...
  { href: "/flooring-calculator", label: "Flooring Calculator" },
  { href: "/gravel-calculator", label: "Gravel Calculator" },
  { href: "/mulch-calculator", label: "Mulch Calculator" },
  { href: "/wallpaper-calculator", label: "Wallpaper Calculator" },
  { href: "/drywall-calculator", label: "Drywall Calculator" },
];
